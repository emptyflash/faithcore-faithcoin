...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"faithcoinaddress\"\n"
            "\nReveals the private key corresponding to 'faithcoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"faithcoinaddress\"   (string, required) The faithcoin address for the private key\n"
            "\nResult:\n"
