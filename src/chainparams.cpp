...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("faithcointools.com", "testnet-seed.faithcointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.faithcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 2056, uint256S("0xd686c51a8ba8b81e4173096785e458253105e1a4d637fd7824893cd2691ee71f")),
            1486949366,
            0,
            0.0
        };
