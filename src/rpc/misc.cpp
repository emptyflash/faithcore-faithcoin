...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"faithcoinaddress\"\n"
            "\nReturn information about the given faithcoin address.\n"
            "\nArguments:\n"
            "1. \"faithcoinaddress\"     (string, required) The faithcoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"faithcoinaddress\", (string) The faithcoin address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"faithcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"faithcoinaddress\"  (string, required) The faithcoin address to use for the signature.\n"
