Faithcoin Core version 0.13.3 is now available from:

  <https://download.faithcoin.org/faithcoin-0.13.3/>
...
Faithcoin Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
