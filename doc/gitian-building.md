...
in `gitian.sigs.fth` to your signing machine and do
...
[gitian.sigs.fth](https://github.com/faithcoin-project/gitian.sigs.fth/) repository, or if that's not possible create a pull
